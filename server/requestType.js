...
module.exports.RequestType = { // they are also used as socket event name
  ...
  CURRENT_GROUP: "REQUEST_CURRENT_GROUP",
  UPDATE_CURRENT_GROUP: "REQUEST_UPDATE_CURRENT_GROUP",
  PERSONAL_CHECKLIST: "REQUEST_PERSONAL_CHECKLIST",
  TOGGLE_CHECKLIST: "REQUEST_TOGGLE_CHECKLIST",
  ACCEPT_QUEST: "REQUEST_ACCEPT_QUEST",
  CHANGE_SCENE: "REQUEST_CHANGE_SCENE",
  // MOVE: "REQUEST_MOVE",
  INITIALIZE: "REQUEST_INITIALIZE",
  TODAY_STUDY_TIME: "REQUEST_TODAY_STUDY_TIME",
  UPDATE_TODAY_STUDY_TIME: "REQUEST_UPDATE_TODAY_STUDY_TIME",
  NEW_QUEST: "REQUEST_NEW_QUEST",
  CREATE_FRIEND : "REQUEST_CREATE_FRIEND" 
  // 앞으로 더 만들기
};

module.exports.ResponseType = {
  OTHER: "RESPONSE_OTHER", // For some invalid requests
  ...
  CURRENT_GROUP: "RESPONSE_CURRENT_GROUP",
  UPDATE_CURRENT_GROUP: "RESPONSE_UPDATE_CURRENT_GROUP",
  PERSONAL_CHECKLIST: "RESPONSE_PERSONAL_CHECKLIST",
  TOGGLE_CHECKLIST: "RESPONSE_TOGGLE_CHECKLIST",
  ACCEPT_QUEST: "RESPONSE_ACCEPT_QUEST",
  CHANGE_SCENE: "RESPONSE_CHANGE_SCENE",
  MOVE: "RESPONSE_MOVE",
  INITIALIZE: "RESPONSE_INITIALIZE",
  TODAY_STUDY_TIME: "RESPONSE_TODAY_STUDY_TIME",
  UPDATE_TODAY_STUDY_TIME: "RESPONSE_UPDATE_TODAY_STUDY_TIME",
  NEW_QUEST: "RESPONSE_NEW_QUEST",
  CREATE_FRIEND : "RESPONSE_CREATE_FRIEND", 
  // 앞으로 더 만들기
  /** ONLY RESPONSE */
  CONNECT: "RESPONSE_CONNECT",
  FRIEND_STOP_STUDY: "RESPONSE_FRIEND_STOP_STUDY",
  FRIEND_START_STUDY: "RESPONSE_FRIEND_START_STUDY",
};
